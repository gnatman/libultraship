...
#include "fast/backends/gfx_direct3d11_vr.h"

namespace Fast {

void Interpreter::SetVRFramebuffer(void* rtv) {
#ifdef _WIN32
    auto rapiVR = dynamic_cast<GfxDirect3D11VR*>(mRapi);
    if (rapiVR) {
        rapiVR->BindExternalRenderTarget((ID3D11RenderTargetView*)rtv);
    }
#endif
}
